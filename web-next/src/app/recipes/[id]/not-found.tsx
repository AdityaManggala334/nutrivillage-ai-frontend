  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center px-4 py-24 text-center">
      ...
      <p className="mt-2 text-sm text-stone-500 dark:text-stone-400">
        Menu yang Anda cari mungkin sudah tidak tersedia. Coba kembali ke halaman Explore untuk
        melihat rekomendasi lain.
      </p>
      <div className="mt-6">
        <ButtonLink href="/explore">Kembali ke Explore</ButtonLink>
      </div>
    </div>
  );
}
